												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{$loop->iteration}}">
															<a class="dropdown-item" data-toggle="modal" data-target="#editarDados{{$exame->id}}" href="#">Editar</a>
															<a class="dropdown-item" class="dropdown-item" data-toggle="modal" data-target="#confirmModal{{ $exame->id }}" href="#">Deletar</a>
														</div>
													</div>
												</td>
											</tr>
											<div class="modal fade" id="confirmModal{{ $exame->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a type="button" class="btn btn-danger" id="confirmBtn" href="{{ route('exame.destroy',$exame->id)}}">Sim</a>
														</div>
													</div>
												</div>
											</div>

											<div class="modal fade" id="editarDados{{$exame->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														<div class="modal-header">
														...
														<div class="modal-body">
															...
															<form action="{{route('exame.update', $exame->id) }}" method="POST">
																...
																<div class="form-group row">
																	...
																	<div class="col-md-10">
																		<input type="text" class="form-control" name="descricao" value="{{$exame->descricao}}" required>
																	</div>
																</div>
																...
																<div class="form-group row">
																	...
																	<div class="col-md-10">
																		<select class="form-control" name="especialidade_id" value="{{$exame->especialidade_id}}" required>
