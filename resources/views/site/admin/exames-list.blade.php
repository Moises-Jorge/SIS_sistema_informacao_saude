															...
															<div class="dropdown">
																...
																<div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{$loop->iteration}}">
																	<a class="dropdown-item"   
                                                                    		data-toggle="modal"
                                                                    		data-target="#editarDados{{$exame->id}}" href="#">Editar</a>
																	<a class="dropdown-item" class="dropdown-item"
                                                                    	data-toggle="modal"
                                                                    	data-target="#confirmModal{{ $exame->id }}" href="#">Deletar</a>
																</div>
															</div>
														</td>
													</tr>
													<div class="modal fade" id="confirmModal{{ $exame->id }}"
															...
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<a type="button" class="btn btn-danger"
																		id="confirmBtn"
																		href="{{ route('exame.destroy',$exame->id)}}">Sim</a>
																</div>
															</div>
														</div>
													</div>

													<div class="modal fade" id="editarDados{{$exame->id}}" tabindex="-1"
														...
														<div class="modal-dialog" role="document">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<!-- Seu formulário aqui -->
																	<form action="{{route('exame.update', $exame->id) }}"
																		method="POST">
																		@csrf
