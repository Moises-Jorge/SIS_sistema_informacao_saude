										...
										<tbody>
												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{$loop->iteration}}">
															...
															<a class="dropdown-item" class="dropdown-item" data-toggle="modal" data-target="#confirmModal{{ $pessoa_clinica->id }}" href="#">Deletar</a>
														</div>
													</div>
												</td>
											</tr>
											@endif
											<div class="modal fade" id="confirmModal{{ $pessoa_clinica->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a type="button" class="btn btn-danger" id="confirmBtn" href="{{ route('clinico.destroy',$pessoa_clinica->id)}}">Sim</a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<!-- Seu formulário aqui -->
														<form action="{{route('clinico.update', $pessoa_clinica->id) }}" method="POST">
															@csrf
