...
<body>
						...
						<div class="card">
							<div class="card-body">
								<div class="table-responsive">
									...
									<button class="btn btn-primary mb-4" style="float: right" data-toggle="modal" data-target="#cadastroEspecialidade">Cadastrar Especialidade</button>
												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{$loop->iteration}}">
															<a class="dropdown-item" data-toggle="modal" data-target="#editarEspecialidade{{$especialidade->id}}" href="#">Editar</a>
															<a class="dropdown-item" class="dropdown-item" data-toggle="modal" data-target="#confirmModal{{ $especialidade->id }}" href="#">Deletar</a>
														</div>
													</div>
												</td>
											</tr>
											<div class="modal fade" id="confirmModal{{ $especialidade->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a type="button" class="btn btn-danger" id="confirmBtn" href="{{ route('especialidade.destroy',$especialidade->id)}}">Sim</a>
														</div>
													</div>
												</div>
											</div>

											<div class="modal fade" id="editarEspecialidade{{$especialidade->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														<div class="modal-header">
														...
														<div class="modal-body">
															...
															<form action="{{route('especialidade.update', $especialidade->id) }}" method="POST">
																...
																<div class="form-group row">
																	...
																	<div class="col-md-10">
																		<input type="text" class="form-control" name="nome" value="{{$especialidade->nome}}"  required pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s]+" title="Por favor, insira apenas letras.">
																	</div>
																</div>
	...
	<!-- Add Modal -->
	<div class="modal fade" id="cadastroEspecialidade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					...
					<form action="{{ route('especialidade.store') }}" method="POST">
						...
						<div class="form-group row">
							<label class="col-form-label col-md-2">Nome</label>
							<div class="col-md-10">
								<input type="text" class="form-control" name="nome"  required pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s]+" title="Por favor, insira apenas letras.">
							</div>
						</div>
