					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item dropdown has-arrow logged-item">
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="assets/img/doctors/doctor-thumb.jpg" width="31" alt="Darren Elder">
								</span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class="user-header">
									<div class="avatar avatar-sm">
										<img src="assets/img/doctors/doctor-thumb.jpg" alt="User Image" class="avatar-img rounded-circle">
									</div>
									<div class="user-text">
										<h6>Darren Elder</h6>
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="assets/img/doctors/doctor-thumb.jpg" alt="User Image">
										</a>
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											...
											<div class="patient-info">
												<ul>
													<li>Telefone <span>utente_contacto</span></li>
													<li>Idade <span>idade + Years, Genero</span></li>
													<li>Grupo Sanguíneo <span>B+</span></li>
												</ul>
											</div>
										</div>
									</div>
